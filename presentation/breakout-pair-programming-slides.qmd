...
Programmers alternate who is the “driver,” responsible for designing, typing the code, and having control over the shared resource (e.g., computer, mouse, and keyboard), and the “navigator,” responsible for providing support to identify errors, offer ideas, or opportunities for improvement (Williams and Kessler, 2002). 
...
Research has repeatedly shown the oppression students with marginalized identities face when collaborating with peers in the mathematics classroom (Leyva et al., 2021), and its impact on the development of students’ mathematical identities (Langer-Osuna, 2011; 2016). 

Gendered and racial microaggressions students face oppress their opportunity to learn and lead historically marginalized Black students (Jett, 2013) and Latina students (Leyva, 2016) to reconsider their STEM pursuits.
...
Complex Instruction
CI as a pedagogy focuses on practices that create structures, protocols, and norms that attend to the ways that status characteristics lead to unequal power and participation (Cohen et al., 1997). 


Roles & Norms
Defining norms and roles to support the autonomy of the groups

Tasks
Teaching via “group-worthy” tasks that require multiple abilities to complete. 

Instructor
Attending to the status of individuals through instructor support
...
# PA: Using Data Visualization to Find the Penguins
