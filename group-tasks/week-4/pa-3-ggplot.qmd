...
Here is an example of the task card provided to students as a reminder during this activity.

[Peer Activity 3: Find the Penguins](pa-3-task-card.qmd)

:::

Some advice: If you aren't sure how to make a specific plot or how to customize
a look over the class text for this week and make use of the [ggplot2 cheatsheet](https://rstudio.github.io/cheatsheets/data-visualization.pdf).
...
To reduce text in the activity the students are working on, the `quarto` document provided removes some of the prior text.

- [Peer Activity: Quarto Document](pa-3-ggplot-student.qmd)

- [Peer Activity: Google Colab](https://colab.research.google.com/drive/1j4nwGxk__CCoQqlFI0ctfXt9x-qCZiuJ?usp=sharing)
...
#| label: q1
#| echo: false
check_question(options = c("Adelie",
                          "Chinstrap",
                          "Gentoo",
                          "Torgerson"), 
               answer = c("Chinstrap"),
...
##### 2. Which species of penguins are found only on Biscoe Island?
...
##### 4. Which species of penguins are found on every island?
...
#| label: q5
#| echo: false
check_question(options = c("group",
                          "linetype",
                          "shape",
                          "alpha"), 
               answer = c("shape"),
