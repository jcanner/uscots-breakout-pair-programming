...
Allison Theobold is an Assistant Professor of Statistics at Cal Poly, where they teach statistics and data science across undergraduate and graduate programs. Allison is the PI on an NSF iUSE grant studying equitable pair programming pedagogy and is a co-PI on an internal Cal Poly grant focused on building a course sequence for statistical computing in R. Outside of work, Allison enjoys running and biking in San Luis Obispo, watching women’s basketball, and sipping cortados.
